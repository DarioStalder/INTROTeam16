...
static const KIN1_UID RoboIDs[] = {
  /* 0: L20, V2 */ {{0x00,0x38,0x00,0x00,0x67,0xCD,0xB5,0x41,0x4E,0x45,0x32,0x15,0x30,0x02,0x00,0x13}}, //dario stalder, räder weiss
  /* 1: L21, V2 */ {{0x00,0x37,0x00,0x00,0x67,0xCD,0xB6,0x31,0x4E,0x45,0x32,0x15,0x30,0x02,0x00,0x13}},   //zimmermann daniel, räder schwarz
...
static void APP_AdoptToHardware(void) {
	...
	//  {0x00,0x38,0x00,0x00,0x67,0xCD,0xB5,0x41,0x4E,0x45,0x32,0x15,0x30,0x02,0x00,0x13} dario stalder, räder weiss
	//  {0x00,0x37,0x00,0x00,0x67,0xCD,0xB6,0x31,x4E,0x45,0x32,0x15,0x30,0x02,0x00,0x13} zimmermann daniel, räder schwarz
  KIN1_UID id;
  uint8_t res;
